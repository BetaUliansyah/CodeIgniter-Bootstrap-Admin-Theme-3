...
<html>
    <head>
        ...
        <!-- Bootstrap -->
        <link href="<?php echo base_url('assets/BAT3/bootstrap/css/bootstrap.min.css') ?>" rel="stylesheet">
        <!-- styles -->
        <link href="<?php echo base_url('assets/BAT3/css/styles.css') ?>" rel="stylesheet">
    ...
    <body>
        ...
        <script src="<?php echo base_url('assets/BAT3/bootstrap/js/bootstrap.min.js') ?>"></script>
        <script src="<?php echo base_url('assets/BAT3/js/custom.js') ?>"></script>
    </body>
</html>